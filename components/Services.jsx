  ...
  return (
    <section className="bg-blue-50 py-16">
      <div className="container mx-auto px-4 text-center">
        ...
        <p className="text-gray-600 mb-12 lg:text-lg">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="bg-white shadow-md rounded-lg p-6">
            <div className="overflow-hidden rounded-lg">
              <img
                ...
                src="images/complete-wash.jpg"
                alt="Complete wash icon"
                width={300}
                height={300}
              />
            </div>
          ...
          <div className="bg-white shadow-md rounded-lg p-6">
            <div className="overflow-hidden rounded-lg">
              <img
                className="rounded-lg transition-transform duration-500 ease-in-out transform hover:scale-110"
                src="images/interior-wash.jpg"
                alt="Interior wash icon"
                width={300}
                height={300}
              />
            </div>
          ...
          <div className="bg-white shadow-md rounded-lg p-6">
            <div className="overflow-hidden rounded-lg">
              <img
                className="rounded-lg transition-transform duration-500 ease-in-out transform hover:scale-110"
                src="images/rubber-blackening.jpg"
                alt="Rubber blackening icon"
                width={300}
                height={300}
              />
            </div>
          ...
          <div className="bg-white shadow-md rounded-lg p-6">
            <div className="overflow-hidden rounded-lg">
              <img
                className="rounded-lg transition-transform duration-500 ease-in-out transform hover:scale-110"
                src="images/engine-wash.jpg"
                alt="Engine wash icon"
                width={300}
                height={300}
              />
            </div>
